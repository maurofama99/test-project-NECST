...
cd /home/maurofama/DeathStarBench/socialNetwork/openshift
...
microk8s kubectl create -f $MICROSERVICE -n $NAMESPACE --dry-run --save-config -o yaml | microk8s kubectl apply -f - --namespace ${NAMESPACE}
